      ...
      <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center">
        <div className="lg:w-0 lg:flex-1">
          ...
          <p className="mt-3 max-w-xl text-lg leading-6 text-gray-300">
            Get notified of upcoming days of action, important campaign news, updates on prisoner
            situations, and more.
          </p>
        </div>
        <div className="mt-8 lg:mt-0 lg:ml-8">
          <form
            ...
            action="https://ichrpcanada.us10.list-manage.com/subscribe/post?u=ea336ef4f849e64d395669ce8&id=b5b3f590c2"
            method="post"
            target="_blank"
          >
            <input
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button className="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-red-500 hover:bg-red-400 focus:outline-none focus:bg-red-400 transition duration-150 ease-in-out">
                Notify me
              </button>
            </div>
          </form>
