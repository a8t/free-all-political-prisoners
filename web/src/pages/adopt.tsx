  ...
  return (
    <Layout rootClassnames="bg-gray-50 overflow-hidden">
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start">
        <div className="relative mb-12 lg:mb-0 z-10">
          ...
          <Link to="adopt/form" className=" text-base max-w-prose mx-auto lg:max-w-none z-10">
            <button className="rounded-md focus:shadow-outline-blue focus:border-blue-300 border-transparent border-4">
        ...
        <div className="relative text-base max-w-prose mx-auto lg:max-w-none z-0">
